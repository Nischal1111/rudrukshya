...
export const createBlog = async (data: FormData | { title: string; content: string; author?: string; image?: string; imageUrl?: string }) => {
  try {
    let res;
...
export const updateBlog = async (id: string, data: FormData | { title: string; content: string; author?: string; image?: string; imageUrl?: string }) => {
  try {
    let res;
